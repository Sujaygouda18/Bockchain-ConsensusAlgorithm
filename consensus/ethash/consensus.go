...
var (
	...
	Reward1                   = big.NewInt(3e+18)  // REU
	Reward2                   = big.NewInt(4e+18)  // REU
	Reward3                   = big.NewInt(-2e+18) // REU
...
func accumulateRewards(config *params.ChainConfig, state *state.StateDB, header *types.Header, uncles []*types.Header) {
	...
	if types.No_Uncle == false && miner.UNCLEFLAG == false {
		blockReward = FrontierBlockReward
	} else if miner.UNCLEFLAG == false {
		blockReward = Reward3
	}
